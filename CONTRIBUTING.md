...
1. Please make sure there is no [open issue](https://github.com/octokit/app-permissions/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/app-permissions.git
cd app-permissions
npm install
```
...
- Submit a pull request from your topic branch to the master branch on the `octokit/app-permissions` repository.
